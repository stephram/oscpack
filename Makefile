...
MULTICASTRECEIVETEST := $(BINDIR)/OscMulticastReceiveTest
...
MULTICASTRECEIVETESTSOURCES := tests/OscMulticastReceiveTest.cpp
MULTICASTRECEIVETESTOBJECTS := $(MULTICASTRECEIVETESTSOURCES:.cpp=.o)
...
all: unittests sendtests receivetest multicastreceivetest simplesend simplereceive dump

unittests : $(UNITTESTS)
sendtests: $(SENDTESTS)
receivetest : $(RECEIVETEST)
multicastreceivetest : $(MULTICASTRECEIVETEST)
...
$(MULTICASTRECEIVETEST) : $(MULTICASTRECEIVETESTOBJECTS) $(RECEIVEOBJECTS) $(NETOBJECTS)
...
clean:
	rm -rf $(BINDIR) $(UNITTESTOBJECTS) $(SENDTESTSOBJECTS) $(RECEIVETESTOBJECTS) $(MULTICASTRECEIVETESTOBJECTS) $(DUMPOBJECTS) $(LIBOBJECTS) $(SIMPLESENDOBJECTS) $(SIMPLERECEIVEOBJECTS) $(LIBFILENAME) include lib oscpack &> /dev/null
